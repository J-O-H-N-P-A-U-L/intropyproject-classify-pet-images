...
# DATE CREATED: Sunday, December 11, 2022                                   
# REVISED DATE: 
...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default = 'vgg', help='which CNN architecture would you like?' )
    parser.add_argument('--dogfile', type=str, default = 'dognames.txt', help='path to dognames file'  )
